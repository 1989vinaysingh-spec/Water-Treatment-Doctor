...
window.openDrawing=function(code,src){const r=oldOpen?oldOpen(code,src):false;resetGesture();setTimeout(()=>{attachGestures();nativeDrawingMode(true);const el=img();if(el){el.onload=()=>{resetGesture();};}},30);return r;};
