const CACHE='wtd-v18.5.5-build22-19-final-v1';
const CORE=[
  './styles.css','./complete-bilingual.js','./bilingual.js','./build22-fix.js','./build22-final-authoritative.css','./build22-final-authoritative.js','./build22-12-home-final.css','./build22-12-home-final.js','./build22-19-final-authority.css','./build22-19-final-authority.js',
...
self.addEventListener('fetch',e=>{
  ...
  if(e.request.mode==='navigate'||/index\.html$/.test(url.pathname)||/(build22-final-authoritative|build22-12-home-final|build22-19-final-authority)\.(js|css)$/.test(url.pathname)){
