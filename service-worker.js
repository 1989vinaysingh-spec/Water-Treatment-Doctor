const CACHE='wtd-v18.5.5-build22-29-readable-drawings-v1';
const CORE=[
...
self.addEventListener('fetch',e=>{
  ...
  if(e.request.mode==='navigate'||/index\.html$/.test(url.pathname)||/(build22-final-authoritative|build22-12-home-final|build22-19-final-authority|build22-20-final-corrected|build22-21-bilingual-qa|build22-22-operator-platform|build22-24-consolidated|build22-25-language-completion)\.(js|css)$/.test(url.pathname)){
